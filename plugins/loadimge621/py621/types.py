...
def ListToPost(List, api):
    ...
    ThisPost.id = List["id"]
    ThisPost.created_at = datetime.strptime(List["created_at"], "%Y-%m-%dT%H:%M:%S.%f%z") if List["created_at"] else None
    ThisPost.updated_at = datetime.strptime(List["updated_at"], "%Y-%m-%dT%H:%M:%S.%f%z") if List["updated_at"] else None
